...
public class hta4Demo extends JFrame implements ActionListener
{
	JLabel l1,l2,l3;
	Font f,f1;
	JTextField t1,t2;
	...
	{
	setLayout(null);
	setTitle("welcome hta4page");
	setSize(1400,700);
	setVisible(true);
	f=new Font("monotype corsiva",Font.BOLD,45);
	f1=new Font("chiller",Font.BOLD,35);
	l1=new JLabel("WELCOME IN SQUARE_HACTARE TO SQUARE_ARCE CONVERTER");
	l2=new JLabel("ARCE:");
	l3=new JLabel("HECTARE:");
	t1=new JTextField();
	t2=new JTextField();
