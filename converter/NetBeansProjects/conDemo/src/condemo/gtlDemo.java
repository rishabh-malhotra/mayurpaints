...
public class gtlDemo extends JFrame implements ActionListener
{
	JLabel l1,l2,l3;
	Font f,f1;
	JTextField t1,t2;
	...
	{
	setLayout(null);
	setTitle("welcome gtlpage");
	setSize(1400,700);
	setVisible(true);
	f=new Font("monotype corsiva",Font.BOLD,45);
	f1=new Font("chiller",Font.BOLD,35);
	l1=new JLabel("WELCOME IN CUBE_GALLON TO CUBE_LITRE CONVERTER");
	l3=new JLabel("LITRE:");
	l2=new JLabel("GALLON:");
	t1=new JTextField();
	t2=new JTextField();
