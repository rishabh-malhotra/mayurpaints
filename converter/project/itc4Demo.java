...
public class itc4Demo extends JFrame implements ActionListener
{
	JLabel l1,l2,l3;
	Font f,f1;
	JTextField t1,t2;
	...
	{
	setLayout(null);
	setTitle("welcome itc4page");
	setSize(1400,700);
	setVisible(true);
	f=new Font("monotype corsiva",Font.BOLD,45);
	f1=new Font("chiller",Font.BOLD,35);
	l1=new JLabel("WELCOME IN SQUARE_INCH TO SQUARE_CENTIMETRE CONVERTER");
	l2=new JLabel("INCH:");
