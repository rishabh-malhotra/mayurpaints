...
public class ktsDemo extends JFrame implements ActionListener
{
	JLabel l1,l2,l3;
	Font f,f1;
	JTextField t1,t2;
	...
	{
	setLayout(null);
	setTitle("welcome ktspage");
	setSize(1400,700);
	setVisible(true);
	f=new Font("monotype corsiva",Font.BOLD,50);
	f1=new Font("chiller",Font.BOLD,35);
	l1=new JLabel("WELCOME IN KILOGRAM TO STONE CONVERTER");
	l3=new JLabel("STONE:");
	l2=new JLabel("KILOGRAM:");
	t1=new JTextField();
	t2=new JTextField();
